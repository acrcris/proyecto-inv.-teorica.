#!/usr/bin/env python3
"""
Combina tres bases de datos en una sola: mnist_R_vs_C_FINAL.db
...
DB1 = Path("/Users/acrcr/Documents/Unal-2025-2/IntroInvTeorica/proyecto/codigo/analisis_criticalidad_minimalista/analisis_RvsC/mnist_R_vs_C_v2-9.db")
DB2 = Path("/Users/acrcr/Documents/Unal-2025-2/IntroInvTeorica/proyecto/codigo/analisis_criticalidad_minimalista/analisis_RvsC/mnist_R_vs_C_v2-10.db")
DB3 = Path("/Users/acrcr/Documents/Unal-2025-2/IntroInvTeorica/proyecto/codigo/analisis_criticalidad_minimalista/analisis_RvsC/mnist_R_vs_C.db")
DB_OUT = Path("/Users/acrcr/Documents/Unal-2025-2/IntroInvTeorica/proyecto/codigo/analisis_criticalidad_minimalista/analisis_RvsC/mnist_R_vs_C_FINAL.db")
...
def main():
    ...
    dbs = [DB1, DB2, DB3]
    db_names = ["v2-9", "v2-10", "mnist_R_vs_C"]
    ...
    print(f"   - DB1 (v2-9): {sorted(tables_db1)}")
    print(f"   - DB2 (v2-10): {sorted(tables_db2)}")
    print(f"   - DB3 (mnist_R_vs_C): {sorted(tables_db3)}")
    ...
    for table in sorted(all_tables):
        ...
        print(f"📋 Tabla: {table}")
        print(f"   - DB1 (v2-9): {count1:,} registros")
        print(f"   - DB2 (v2-10): {count2:,} registros")
        print(f"   - DB3 (mnist_R_vs_C): {count3:,} registros")
        
        # Seleccionar la DB con más registros
        counts = [(count1, DB1, "v2-9"), (count2, DB2, "v2-10"), (count3, DB3, "mnist_R_vs_C")]
